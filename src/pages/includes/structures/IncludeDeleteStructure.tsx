...
export default function IncludeDeleteStructure({
  isActive,
  setIsActive,
    ...
    >
      <div className="flex w-full lg:w-1/2 justify-between items-center">
        <SubHeading color="primary" smallerOnMobile nobreak>
          ...
          <span className="text-base-content">{name}</span> structure?
        </SubHeading>
